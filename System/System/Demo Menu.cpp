...
void menuStaff(string username, SchoolYear*& yearHead) {
    ...
    while (true)
    {
        ...
        else if (chose == "10")
        {
        ...
        else if (chose == "12") {       // addstuincourse
            system("cls");
            UIlite();
            findLastSYandSM(yearHead, yearNow, smNow);
            ...
            string n;
            cout << "| Type in: \n";
            cout << "| 1. Export list of student in course\n";
            cout << "| 2. Export list of student in course to enter mark\n";
            cout << "| Or other key to return to menu!\n| ";
            getline(cin, n, '\n');
            if (n == "1") {
                system("cls");
                UIlite();
                ...
                if (courseCur != nullptr)
                {
                    if (exportListStudentInCourseCSV_dssv(courseCur) == true)
                        cout << "| Exported course " << s << " to Export folder" << endl;
                    else cout << "| Failed" << endl;
                }
